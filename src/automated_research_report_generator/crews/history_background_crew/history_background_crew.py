...
class HistoryBackgroundCrew:
    ...
    pack_title = "历史与背景分析包"
    pack_focus = "围绕发展时间线、治理结构、股权关系和关键里程碑完成历史专题研究。"
    output_title = "历史与背景分析包"
    search_guidance = "外部搜索只用于补充背景和交叉验证，主证据应优先来自公司披露材料。"
    extract_guidance = "重点提取发展时间线、股权结构、董事会与管理层信息。"
    qa_guidance = "确认治理、股东关系和关键历史事件是否已经形成可验证结论。"
    synthesize_guidance = "输出要突出时间线、治理结构、潜在治理风险和仍待验证事项。"
    ...
    def qa_check_agent(self) -> Agent:
        ...
        功能：检查当前 history pack 的 registry 覆盖度，并补 gap_note 与 next_action。
