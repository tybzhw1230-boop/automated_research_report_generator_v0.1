...
from automated_research_report_generator.tools import AddEntryTool, AddEvidenceTool, FinancialModelTool, ReadRegistryTool, RegistryReviewTool, StatusUpdateTool
...
class FinancialCrew:
    ...
    def qa_check_agent(self) -> Agent:
        ...
        功能：检查当前 finance pack 的 registry 覆盖度，并补 gap_note 与 next_action。
